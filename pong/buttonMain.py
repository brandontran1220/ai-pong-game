...
player1Button = button.Button(WIDTH / 4 - player1_img.get_width() // 2, HEIGHT // 2 - (player1_img.get_height() // 2), player1_img, 1)
player2Button = button.Button(WIDTH * (3/4) - (player2_img.get_width() // 2), HEIGHT // 2 - (player2_img.get_height() // 2), player2_img, 1)
mainTitle = "PONG"
